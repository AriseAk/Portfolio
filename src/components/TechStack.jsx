    ...
    <section ref={containerRef} className="relative w-full min-h-screen flex flex-col items-start justify-center py-20 px-4 md:px-20 overflow-hidden">
      ...
      <div className="tech-stack__container w-full">
        <div className="tech-stack__title mb-10" ref={titleRef}>
          <h1 className="tech-stack__title-text text-5xl md:text-7xl font-bold text-white">Tech Stack</h1>
        </div>

        {/* MAIN BOX CONTAINER */}
        <div 
          ref={boxRef}
          className="relative w-full max-w-6xl p-6 md:p-8 rounded-2xl border border-white/10 bg-[#10100e]/60 backdrop-blur-md shadow-2xl mr-auto"
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
            ...
            {/* Added 'h-full justify-center' to center vertically if the left column is taller */}
            <div className="flex flex-col gap-6 justify-center items-center lg:items-end h-full">
                
                {/* Profile Details Card */}
                <div className="relative w-full max-w-[420px] rounded-lg overflow-hidden border border-white/5 bg-white/5 hover:border-white/20 transition-all duration-300">
                  <img
                    src="https://raw.githubusercontent.com/AriseAk/Portfolio/main/profile-summary-cards/profile-details.svg"
                ...
                <div className="relative w-full max-w-[420px] rounded-lg overflow-hidden border border-white/5 bg-white/5 hover:border-white/20 transition-all duration-300">
                  <img
                    src="https://raw.githubusercontent.com/AriseAk/Portfolio/main/profile-summary-cards/stats.svg"
                    alt="GitHub Stats"
                    className="w-full opacity-90 hover:opacity-100 transition duration-300"
                    loading="lazy"
                  />
